...
export RES=ne16pg3_tn14 # ne30pg3_tn14, f45_f45_mg37, ne16pg3_tn14
export MACH='betzy'
...
hist_fincl1='BTRAN', 'DSTFLXT', 'EFLX_LH_TOT', 'FATES_AREA_PLANTS', 'FATES_AUTORESP', 'FATES_BURNEDAREA_LU', 'FATES_BURNFRAC',
 'FATES_FIRE_CLOSS', 'FATES_FRACTION', 'FATES_GPP', 'FATES_VEGC', 'FATES_VEGC_ABOVEGROUND',
'FATES_GPP_LU', 'FATES_GRAZING', 'FATES_HET_RESP', 'FATES_LAI', 'FATES_LAI_PF', 'FATES_LEAFC', 'FATES_LUCHANGE_WOODPROD_C_FLUX',
'FATES_MORTALITY_CFLUX_CANOPY', 'FATES_NEP', 'FATES_NPLANT_SZ', 'FATES_NPP', 'FATES_NPP_LU', 
'FATES_VEGC_ABOVEGROUND_SZPF', 'FATES_VEGC_LU', 'FATES_VEGC_SZPF', 'FCO2', 'FIRE', 'FLDS', 
...
'FATES_MORTALITY_FIRE_CFLUX_PF', 'FATES_MORTALITY_HYDRO_CFLUX_PF', 'FATES_MORTALITY_BACKGROUND_CFLUX_PF',
...
'FATES_RECRUITMENT_PF', 'FATES_NPLANT_SZPF', 
'FATES_GPP_PF', 'FATES_NPP_PF', 'ALTMAX', 'FATES_NOCOMP_PATCHAREA_PF', 'FATES_SEED_BANK_PF', 
'FATES_BASALAREA_SZ', 'FATES_VEGC_PF', 'FATES_AGSAPWOOD_ALLOC_SZPF', 'FATES_AGSTRUCT_ALLOC_SZPF',
'FATES_BGSAPWOOD_ALLOC_SZPF', 'FATES_BGSTRUCT_ALLOC_SZPF', 'FATES_CROWNAREA_PF',
