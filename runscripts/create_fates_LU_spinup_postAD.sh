...
export TAG='noresm-fates-ne16-LU-PPE-postAD-spinup'
...
./xmlchange RUN_STARTDATE=0201-01-01 # check this matches end of AD spinup run
...
./xmlchange EXEROOT=/cluster/work/users/jessica/ncsrevise_runs/noresm-fates-ne16-LU-PPE-AD-spinup.N1048fbece-Fab73a7eb7.2026-01-06/bld # point to build from the ad spin up

cat >>  user_nl_clm <<EOF
finidat='/cluster/work/users/jessica/ncsrevise_runs/noresm-fates-ne16-LU-PPE-AD-spinup.N1048fbece-Fab73a7eb7.2026-01-06/run/'
